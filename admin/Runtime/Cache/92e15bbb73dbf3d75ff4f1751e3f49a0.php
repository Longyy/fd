...
<form action="<?php echo u('Doctor/addDoctorWork');?>" method="post" name="myform" id="myform" enctype="multipart/form-data"
	...
	<div class="pad-10">
					...
					<tr>
						...
						<td>
							<select onchange="selectCenter(this)" name="medical_center_id" id="medical_center_id" style="width:200px;">
								...
								<?php if(is_array($medicalCenterData)): $i = 0; $__LIST__ = $medicalCenterData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val["id"]); ?>"><?php echo ($val["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
						</td>
					</tr>
					<tr>
						...
						<td>
							<select name="doctor_id" id="ddlDoctor" style="width:200px;">
								<!--<?php if(is_array($doctorData)): $i = 0; $__LIST__ = $doctorData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>-->
		...
		<input class="date input-text" type="text" name="work_date" id="work_date" size="18" value="" />	
