      ...
      <div id="div_setting_1" class="contentList pad-10">
          <table width="100%" cellpadding="2" cellspacing="1" class="table_form">
            ...
            <tr>
              ...
              <td>
              		<input type="text" name="site[site_domain]" size="80" value="<?php echo ($set["site_domain"]); ?>">
					<span style="color:red">注意：域名后面不加/<span>例如:http://www.baidu.com 是正确的
			  </td>
            </tr>    
			<tr>
            ...
            <tr>
              ...
              <td><input type="text" name="site[comment_time]" id="comment_time" class="input-text" value="<?php echo ($set["comment_time"]); ?>"><span>0表示不限制,单位/秒</span></td>
            </tr>						
            <tr>
              <th><?php echo L('site_icp');?> :</th>
              <td><input type="text" name="site[site_icp]" id="site_icp" class="input-text" value="<?php echo ($set["site_icp"]); ?>"></td>
            </tr>
            <tr>
		...
		<table width="100%" cellpadding="2" cellspacing="1" class="table_form">    
		 	<tr>              
              <td colspan=2>
				   ...
				   <span class="green">您可以&nbsp;&nbsp;<a target="_blank" href="./data/logs/send_mail_error.txt">查看</a> &nbsp;&nbsp;&nbsp; <a href="<?php echo U('Setting/delMailLog');?>">删除</a></span>     
              </td>
            </tr>   
            <tr>
