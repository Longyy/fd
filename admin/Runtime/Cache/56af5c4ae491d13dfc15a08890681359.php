...
<div class="pad-lr-10">
	<form id="myform" name="myform" action="<?php echo u('TransferHospital/delete');?>" method="post" onsubmit="return check();">
		<div class="table-list">
			<table width="100%" cellspacing="0">
				...
				<tbody>
				<?php if(is_array($transferHospitalList)): $i = 0; $__LIST__ = $transferHospitalList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
