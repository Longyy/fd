...
<table width="90%" id="mytab" border="1" class="t1">
	...
	<tr class="a1">
		...
		<td>来源：</td>
		<td><?php echo ($model['resource']); ?></td>
	</tr>
	<tr class="a1">
		<td>求诊类型：</td>
		<td><?php echo $model['order_type']==1?'转诊':'预约';?></td>
		<td>转诊号:</td>
		<td><?php echo ($model['order_code']); ?></td>
		<td>临床诊断：</td>
		<td><?php echo ($model['diagnose']); ?></td>
	</tr>
	<tr class="a1">
		<td>病情描述：</td>
		<td><?php echo ($model['description']); ?></td>
		<td>过往治疗史:</td>
		<td><?php echo ($model['before_treat']); ?></td>
		<td>治疗要求：</td>
		<td><?php echo ($model['demand']); ?></td>
	</tr>
	<tr class="a1">
		<td>医疗中心：</td>
		<td><?php echo ($model['center_name']); ?></td>
		<td>医生:</td>
		<td><?php echo ($model['doctor_name']); ?></td>
		<td></td>
		<td></td>
