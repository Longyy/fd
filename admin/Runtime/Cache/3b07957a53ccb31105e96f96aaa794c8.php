...
<div id="header">
    ...
    <div class="col-auto" style="overflow: visible">
		...
		<div class="log_right white cut_line">
	       <!---
		    <a target="_blank" href="www.shiraz-soft.com">官方网站</a>
			<span>|</span>
			<a target="_blank" href="bbs.shiraz-soft.com">支持论坛</a>
			<span> </span>
			<a target="_blank" href="www.shiraz-soft.com">Provide by (shiraz-soft.com)</a>
		   -->		
        </div>             
    </div>
...
function _M(tag,targetUrl) {
	$.get("<?php echo u('Public/menu');?>", {tag:tag}, function(data){
		$("#leftMain").html(data);
		var firstMenu =$(".left_menu").find("ul li:first");
				$(firstMenu).attr("class","sub_menu on fb blue");
		_MP(firstMenu.data("navid"),firstMenu.data("url"));
