...
$sql = "SELECT t1.*,t2.name as doctor_name,t4.name as center_name FROM cms_appoint t1 left join cms_doctor t2 on t1.doctor_id=t2.id
...
<a href="<?php echo( $pageUrl) ?>zixunjianyi.php?id=<?php echo( $_GET["id"]) ?>"> <button type="button" class="btn btn-primary">咨询建议</button></a>
