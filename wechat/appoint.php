...
<div class="ect-bg">
    <header class="ect-header ect-margin-tb ect-margin-lr text-center icon-write">
        <a href="javascript:history.go(-1)" class="pull-left ect-icon ect-icon1 ect-icon-history">&nbsp;</a> <span>预约表</span>
...
function chooseImage(obj){
    ...
    wx.chooseImage({
        ...
        success: function(res) {
            ...
            $("#divUploadImg").append("<img src=\""+localIds+"\" height=\"50px\"  width=\"50px;\" style=\"float: left; margin-top: 2em\">");
