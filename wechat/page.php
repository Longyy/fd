    ...
    protected function _get_link($page,$text)
    {
        switch ($this->method) {
            case 'ajax':
                ...
                $json = json_encode(array('u'=>$parameter,'p'=>$page));
                return '<li><a class="jspage" onclick="search(this,\'ajax\')" href="javascript:void(0)" data-page='.$json.'>'.$text.'</a>'."</li>";
                break;
...
//        }
    ...
    public  function show_2()
    {
        ...
        {
            $return = '<nav><ul class="pagination"><li>';
            $return .= $this->up_page('&laquo;').'</li>';
            ...
            $return .= $this->down_page('&raquo;').'</ul></nav>';
            return $return;
        }
    }
