    ...
    <div class="ect-padding text-center">
        ...
        <section class="pub-tab">
            <ul class="nav nav-tabs text-center">
                ...
                <li class="col-xs-4 cur" style="border:solid 0px red;width:100px;"><a data-toggle="tab" role="tab" href="#three">其他</a></li>
            </ul>
            <div class="tab_content">
                <div class="rl-txt" id="l3" style="display:block">
                    ...
                    <li id="daixiadan" onClick="">治疗确认表</li></br>
                    <li id="daixiadan" onClick="">转诊信息列表</li></br>
