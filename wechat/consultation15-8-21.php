...
<center>
    <button type="button" id="btnSubmit" onclick="submit()" style="width: 200px;" class="btn btn-primary"><span id="spanEnter">提交</span>
...
//            return;
//        }
//        if ($.trim($("#txtDiagnose").val()) != "" && checkLength($("#txtDiagnose").val()) > 70) {
//            alert('临床诊断长度不能超过70个字');
//            return;
//        }
//        if ($.trim($("#txtDescription").val()) != "" && checkLength($("#txtDescription").val()) > 70) {
//            alert('病情描述长度不能超过70个字');
//            return;
//        }
//        if ($.trim($("#txtBeforeTreat").val()) != "" && checkLength($("#txtBeforeTreat").val()) > 70) {
//            alert('曾经过往治疗史长度不能超过70个字');
//            return;
//        }
//        if ($.trim($("#txtRequire").val()) != "" && checkLength($("#txtRequire").val()) > 70) {
//            alert('治疗要求长度不能超过70个字');
//            return;
//        }
