...
class WeixinModel extends Model
{
    ...
    public function __construct()
    {
        ...
        $content = $this->wp_file_get_contents('php://input');
...
//
//			$this->wxcpt = new \WXBizMsgCrypt ( 'weixin', $info ['encodingaeskey'], $info ['appid'] );
//
//			$sMsg = ""; // 解析之后的明文
...
//		}
    ...
    private function wp_file_get_contents($url)
    {
    ...
    //获取粉丝基础信息
    public function getFansInfo($open_id)
    {
